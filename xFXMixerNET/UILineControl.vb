...
Public Class UILineControl
    ...
    Public Property LineControl() As Object
        ...
        Set(ByVal Value As Object)
            ...
            Select Case mUIControlType
                Case UIControlTypeConstants.Fader
                    With mFader
                        .TickFrequency = (mLineControl.Max - mLineControl.Min) / 10
                        .Minimum = mLineControl.Min
                        .Maximum = mLineControl.Max
                        .Value = mLineControl.UniformValue
                    End With
                    mLineControl.Binding.Define(mFader, "Value", "ValueChanged")
                Case UIControlTypeConstants.Switch
                    mSwitch.Checked = mLineControl.UniformValue
                    mLineControl.Binding.Define(mSwitch, "Checked", "CheckedChanged")
            End Select
    ...
    Public Sub New(ByVal lc As CControl, ByVal ct As UIControlTypeConstants)
        mUIControlType = ct
    ...
    Public Sub New(ByVal lc As CCtrlItem, ByVal ct As UIControlTypeConstants)
        mUIControlType = ct
        ...
        If mEditMode And msg.Msg = WM_KEYDOWN Then
            If (keyData And Keys.Control) = Keys.Control Then
                Select Case keyData Xor Keys.Control
                    Case Keys.Up
                        Me.UILineControlResize(0, -1, UILineControl.MouseActionConstants.Move, True)
                        Return True
                    Case Keys.Down
                        Me.UILineControlResize(0, 1, UILineControl.MouseActionConstants.Move, True)
                        Return True
                    Case Keys.Left
                        Me.UILineControlResize(-1, 0, UILineControl.MouseActionConstants.Move, True)
                        Return True
                    Case Keys.Right
                        Me.UILineControlResize(1, 0, UILineControl.MouseActionConstants.Move, True)
                        Return True
            ...
            ElseIf (keyData And Keys.Shift) = Keys.Shift Then
                Select Case keyData Xor Keys.Shift
                    Case Keys.Up
                        Me.UILineControlResize(0, -1, UILineControl.MouseActionConstants.ResizeBottom, True)
                        Return True
                    Case Keys.Down
                        Me.UILineControlResize(0, 1, UILineControl.MouseActionConstants.ResizeBottom, True)
                        Return True
                    Case Keys.Left
                        Me.UILineControlResize(-1, 0, UILineControl.MouseActionConstants.ResizeRight, True)
                        Return True
                    Case Keys.Right
                        Me.UILineControlResize(1, 0, UILineControl.MouseActionConstants.ResizeRight, True)
                        Return True
